...
pt[, old := hhld_age_1 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_2 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_3 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_4 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_5 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_6 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_7 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_8 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_9 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_10 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_11 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]
pt[, old := hhld_age_12 %in% c("65-69", "70-74", "75-79", "80-84", "85 years or older", "85+")]

  #create contact vars
  pt[, q_u18_work    := max(Q75_u18_work,    Q76_u18_work)]
  pt[, q_u18_school  := max(Q75_u18_school,  Q76_u18_school)]
  pt[, q_u18_else    := max(Q75_u18_else,    Q76_u18_else)]
  pt[, q_1864_work   := max(Q75_1864_work,   Q76_1864_work)]
  pt[, q_1864_school := max(Q75_1864_school, Q76_1864_school)]
  pt[, q_1864_else   := max(Q75_1864_else,   Q76_1864_else)]
  pt[, q_o64_work    := max(Q75_o64_work,    Q76_o64_work)]
  pt[, q_o64_school  := max(Q75_o64_school,  Q76_o64_school)]
  pt[, q_o64_else    := max(Q75_o64_else,    Q76_o64_else)]
  ...
  pt <- cbind(pt[, .(country, panel, wave, survey_round, date, weekday, part_id, part_wave_uid, sample_type,
                     ...
                     part_workattendance_7days_wave14_33, part_workattendance_limit_wave1_13, part_workattendance_yesterday_wave14_33,
                     part_face_mask,
                     hh_size, old,
