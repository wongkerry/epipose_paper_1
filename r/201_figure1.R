...
ggplot(surveys, aes(fill=country, y=N, x=ym_num)) + 
       ...
       geom_text(aes(x=612, y=39000, family = "Segoe UI"), label = "2021", size=4) +
       geom_text(aes(x=624, y=39000, family = "Segoe UI"), label = "2022", size=4) +
       ...
       theme_minimal() +
       guides(fill=guide_legend(title = "", nrow = 3, byrow = FALSE, 
